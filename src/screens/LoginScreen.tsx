...
// Assuming asset path works with require in TS context, or it resolves via module mapping
const Logo = require('../assets/images/tickethub-logo.png');

const { width, height } = Dimensions.get('window');

// Define a reusable scaling function type for clarity
...
// Define NavigationProp type if available, otherwise use a generic reference
