...
const UserManagementScreen = ({ navigation }) => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      // Optionally show an error message or empty state
      setUsers([]);
    } finally {
      setLoading(false);
    }
    ...
    <ScreenContainer>
      ...
      <View style={styles.searchSection}>
        ...
        <View style={styles.filterContainer}>
          {["all", "customer", "admin", "event_manager", "support"].map(
            (filterType) => (
              <TouchableOpacity
                key={filterType}
                style={[
          ...
          <View style={[styles.modalContent, styles.createUserModal]}>
            ...
            <ScrollView style={styles.createUserForm}>
              <View style={styles.formRow}>
                <View style={styles.halfInput}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setCreateUserData({ ...createUserData, firstName: text })
                    }
                  />
                </View>
                <View style={styles.halfInput}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setCreateUserData({ ...createUserData, lastName: text })
                    }
                  />
                </View>
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setCreateUserData({ ...createUserData, email: text })
                  }
                />
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setCreateUserData({ ...createUserData, password: text })
                  }
                />
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setCreateUserData({ ...createUserData, phone: text })
                  }
                />
              </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <View style={styles.roleOptions}>
                  {["customer", "event_manager", "support", "admin"].map(
                    (role) => (
                      <TouchableOpacity
                        key={role}
                        style={[
                        ...
                        onPress={() =>
                          setCreateUserData({ ...createUserData, role })
                        }
                      >
                        <View
                          style={[
            ...
            <View style={styles.modalActions}>
              ...
              <TouchableOpacity
                style={[
                  styles.createButton,
                  createUserLoading && styles.createButtonDisabled,
                ]}
