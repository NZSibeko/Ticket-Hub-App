...
const styles = StyleSheet.create({
  ...
  demoNotice: { marginTop: 16, borderRadius: 18, backgroundColor: '#f5f3ff', borderWidth: 1, borderColor: '#ddd6fe', padding: 16, flexDirection: 'row', alignItems: 'flex-start', gap: 12 },
  demoNoticeText: { flex: 1, fontSize: 12, lineHeight: 18, color: '#6d28d9' },
  demoButton: { marginTop: 16, alignSelf: 'flex-start', minHeight: 42, paddingHorizontal: 14, borderRadius: 12, backgroundColor: '#eff6ff', borderWidth: 1, borderColor: '#bfdbfe', flexDirection: 'row', alignItems: 'center', gap: 8 },
  demoButtonText: { fontSize: 13, fontWeight: '700', color: '#2563eb' },
