...
class MetricsService {
  ...
  async safeInitialize() {
    return new Promise<void>(async (resolve, reject) => {
      ...
      try {
        ...
        const uptimeMs = new Date().getTime() - this.startTime.getTime();
  ...
  async updateUptimeMetrics() {
    try {
      ...
      const uptimeMs = new Date().getTime() - this.startTime.getTime();      const uptimeDays = (uptimeMs / (1000 * 60 * 60 * 24)).toFixed(2);
